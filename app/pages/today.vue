<template>
  <div class="p-6 max-w-5xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
      ...
      <NuxtLink to="/topics" class="btn-secondary justify-center">
    ...
    <div class="flex items-center justify-between mt-12 mb-4">
      ...
      <NuxtLink to="/topics" class="text-small text-accent-primary hover:underline">Ver todos</NuxtLink>
    </div>
    ...
    <div v-if="topicProgress.length" class="mt-12">
      <div class="flex items-center justify-between mb-4">
        ...
        <NuxtLink to="/topics?view=graph" class="text-small text-accent-primary hover:underline">Ver mapa</NuxtLink>
      </div>
      <div class="space-y-3">
